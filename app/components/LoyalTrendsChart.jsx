...
export default function LoyalTrendsChart({ data = [] }) {
      ...
      <BlockStack gap="300">
        <BlockStack gap="050">
          <Text as="h2" variant="headingMd" fontWeight="bold">
            Loyal and potential loyal
          </Text>
          <Text as="p" variant="bodySm" tone="subdued">
            Tracking high-value customer count growth over time
          </Text>
        </BlockStack>
            ...
            <div style={{ width: "100%", height: 280 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 5 }}>
                  ...
                  <Bar dataKey="Loyal" fill="#5C6AC4" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="Potential Loyal" fill="#2C6ECB" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ) : (
